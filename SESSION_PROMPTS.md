...
## C. 【已归档】T-21 施工 prompt（该票已于 2026-09-15 验收通过；deepseek harness 版本，含熔断规则）

> 归档说明：T-21 由 deepseek harness 分 5 块完成，全程无死循环、integration 只跑被点名的 3 个。下一个派工对象 = **T-22（P3 微票，补证据）**，其内容直接写在 `TICKETS_M2A.md` 的 T-22 里（很短，无需单独 prompt）；M2.0 正式波仍暂缓。
